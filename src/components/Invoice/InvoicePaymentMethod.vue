    ...
    <template #default>
      <div class="invoice__paymentmethod row q-pa-md">
        <div class="heading gt-xs row justify-between">
          <h6 class="q-ma-none q-mt-md text-weight-bold q-mb-md">
            Payment Method
          </h6>
          <q-btn
            color="primary"
        ...
        <div class="heading lt-sm row justify-between">
          <h6 class="q-ma-none q-mt-md text-body1 text-weight-bold q-mb-xs">
            Payment Method
          </h6>
          <q-btn
            color="primary"
            flat
            class="text-weight-bold text-caption q-mt-md"
            label="Select Payment"
          />
        </div>
        <div
          class="details__container min-w-full bg-custom-two rounded q-px-lg"
        >
          <div class="row min-w-full items-center justify-between">
            <h6 class="q-ma-none gt-xs text-subtitle1 text-weight-bold q-mb-md">
              Wire Transfer
            </h6>
            <h6 class="q-ma-none lt-sm text-body2 text-weight-bold q-mb-md">
              Wire Transfer
            </h6>
            <img
              class="gt-xs q-mb-md"
              width="120"
              src="src/assets/wiselogo.webp"
          ...
          <div class="account__details">
            ...
            <dl class="lt-sm custom-fit row items-center">
              ...
              <dd class="text-weight-bold text-caption">
                {{ account.accountName }}
              </dd>
            </dl>
